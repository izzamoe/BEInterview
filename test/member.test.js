...
import app from '../app'; // Ubah sesuai dengan file Express app Anda
...
describe('GET /members', () => {
    it('should return a list of members with their borrowings count', async () => {
        ...
        expect(response.body.members).toHaveLength(3); // Sesuaikan dengan jumlah anggota yang diharapkan
